...
namespace efureev\settings\components;
...
class Settings extends Component
{
     ...
     */
    public $modelClass = 'efureev\settings\models\BaseSetting';

    /**
     * Model to for storing and retrieving settings
     *
     * @var \efureev\settings\models\SettingInterface
     */
    protected $model;
     ...
     */
    public $cacheKey = 'efureev/settings';
    ...
    public function get($key, $section = null, $default = null)
    {
        ...
        if (isset($data[$section][$key][0])) {
            if ($data[$section][$key][1] !== 'object') {
                settype($data[$section][$key][0], self::normalizeType($data[$section][$key][1]));
            }
        } else {
